...
export function Sidebar() {
  ...
  const [expanded, setExpanded] = useState<string[]>(["hrms", "crm", "finance"]);
      ...
      <div className="flex-1 overflow-y-auto py-4 px-3 scrollbar-thin">
        {navGroups.map((group) => (
          <div key={group.title} className="mb-5">
            <p className="px-3 text-[10px] font-semibold text-white/25 uppercase tracking-widest mb-2">
              {group.title}
            </p>
      ...
      <div className="border-t border-white/5 p-3">
        <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-white/80 truncate">Alex Morgan</p>
