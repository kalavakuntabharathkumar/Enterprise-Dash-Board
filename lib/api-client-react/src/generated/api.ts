...
/**
 * @summary Send message to AI copilot
 */
export const aiChat = async (aiChatInput: AiChatInput, options?: RequestInit): Promise<CopilotResponse> => {

  return customFetch<CopilotResponse>(getAiChatUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
